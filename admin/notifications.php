...
echo "\n";
echo "<div id=\"main\">\n";
echo "   <br><h2>&nbsp;&nbsp;Notifications</h2>\n";
echo "   &nbsp;&nbsp;&nbsp;&nbsp;<a id=\"button\"  href=\"./notifications_create.php\" class=\"btn btn-warning\">Create</a><br>\n";
echo "     </div>\n";
...
echo "                  <td><a href=\"./notifications_update.php?update=$id\"><i class=\"fa fa-pencil-square-o\" style=\"font-size:24px;color:blue\"></i></a>&nbsp&nbsp&nbsp<a href=\"#\" data-href=\"./notifications.php?delete=$id\" data-toggle=\"modal\" data-target=\"#confirm-delete\"><i class=\"fa fa-trash-o\" style=\"font-size:24px;color:red\"></i></a></td>\n";
echo "                </tr>\n";
echo "              </tbody>\n";
				};
echo "            </table>\n";
